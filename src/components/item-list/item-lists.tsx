...
interface Item {
  ...
  quantity: number;
  packaging: string;
  image1: string; // Adjust this based on how your images are stored
  companyName: string;
}
...
export default function ItemList({ companyName }: { companyName: string }) {
  ...
  return (
    <div className="pt-14 pb-14 bg-[#76B2E4] border-black border-l-[0.3rem] border-r-[0.3rem] rounded-[3rem] ">
      ...
      <h1 className="text-white text-[2.5rem] mr-11 font-semibold p-6">Products</h1>
      ...
      <Select onValueChange={setSortCriteria}>
        <SelectTrigger className=" hover:shadow-none w-[180px] border-2 border-black dark:border-white uppercase bg-[#76B2E4] text-black transition duration-200 text-sm shadow-[1px_1px_rgba(0,0,0),2px_2px_rgba(0,0,0),3px_3px_rgba(0,0,0),4px_4px_rgba(0,0,0),5px_5px_0px_0px_rgba(0,0,0)] dark:shadow-[1px_1px_rgba(255,255,255),2px_2px_rgba(255,255,255),3px_3px_rgba(255,255,255),4px_4px_rgba(255,255,255),5px_5px_0px_0px_rgba(255,255,255)]"
        >
          <SelectValue placeholder="Sort by" />
        </SelectTrigger>
        <SelectContent>
          <SelectItem value="No Filter">No Filter</SelectItem> {/* No Filter option */}
      ...
      <SelectTrigger className=" ml-5 hover:shadow-none w-[180px] border-2 border-black dark:border-white uppercase bg-[#76B2E4] text-black transition duration-200 text-sm shadow-[1px_1px_rgba(0,0,0),2px_2px_rgba(0,0,0),3px_3px_rgba(0,0,0),4px_4px_rgba(0,0,0),5px_5px_0px_0px_rgba(0,0,0)] dark:shadow-[1px_1px_rgba(255,255,255),2px_2px_rgba(255,255,255),3px_3px_rgba(255,255,255),4px_4px_rgba(255,255,255),5px_5px_0px_0px_rgba(255,255,255)]"
...
<Select onValueChange={(value) => setItemLimit(Number(value))}>
  <SelectTrigger className="ml-5 hover:shadow-none w-[180px] border-2 border-black dark:border-white uppercase bg-white text-black transition duration-200 text-sm shadow-[1px_1px_rgba(0,0,0),2px_2px_rgba(0,0,0),3px_3px_rgba(0,0,0),4px_4px_rgba(0,0,0),5px_5px_0px_0px_rgba(0,0,0)] dark:shadow-[1px_1px_rgba(255,255,255),2px_2px_rgba(255,255,255),3px_3px_rgba(255,255,255),4px_4px_rgba(255,255,255),5px_5px_0px_0px_rgba(255,255,255)]">
  ...
  <SelectContent>
    ...
    <SelectItem value={sortedItems.length.toString()}>All</SelectItem> {/* "All" option */}
  </SelectContent>
</Select>
      ...
      {sortedItems.slice(0, itemLimit).map(item => (
          ...
          <CardContainer className="inter-var w-[30rem] max-h-[30rem] flex flex-col justify-between"> {/* Adjust max height */}
                <CardBody className="bg-gray-50 min-h-[30rem] relative group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[30rem] h-auto rounded-xl p-6 border">
                  <CardItem
                    translateZ="10"
